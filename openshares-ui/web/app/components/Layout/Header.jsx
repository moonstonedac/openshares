...
class Header extends React.Component {
    ...
    render() {
        ...
        let tradeLink = this.props.lastMarket && active.indexOf("market/") === -1 ?
            ...
            <a className={cnames({active: active.indexOf("market/") !== -1})} onClick={this._onNavigate.bind(this, "/market/USD_OPS")}><Translate component="span" content="header.exchange" /></a>;
            ...
            <div className="header menu-group primary">
                ...
                <div className="grid-block show-for-medium">
                    <ul className="menu-bar">
                        {!currentAccount ? null : <li><Link to={`/dashboard`} activeClassName="active"><Translate content="header.dashboard" /></Link></li>}
