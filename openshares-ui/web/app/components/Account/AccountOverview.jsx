...
class AccountOverview extends React.Component {
    ...
    _renderBalances(balanceList) {
        ...
        balanceList.forEach( balance => {
            ...
            let isOpenAsset = asset && asset.has("openasset_data_id");
            ...
            if (asset) {
                ...
                let preferredMarket = market ? market : core_asset ? core_asset.get("symbol") : "OPS";
            ...
            balances.push(
                <tr key={balance} style={{maxWidth: "100rem", backgroundColor: !includeAsset ? "#3E3E3E" : null}}>
                    {/*isOpenAsset ? <td><div onClick={this._onSettleAsset.bind(this, asset.get("id"))} className="button outline"><Translate content="account.settle" /></div></td> : <td></td>*/}
                        ...
                        <table className="table">
                            <thead>
                                <tr>
                                    ...
                                    {/*<<th style={{textAlign: "right"}}><Translate component="span" content="account.ops_market" /></th>*/}
                                    {showAssetPercent ? <th style={{textAlign: "right"}}><Translate component="span" content="account.percent" /></th> : null}
                                    <th>{/* Hide button */}</th>                                </tr>
                            </thead>
                            <tbody>
                                {includedBalances}
