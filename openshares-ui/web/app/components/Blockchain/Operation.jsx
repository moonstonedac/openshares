...
let {operations} = require("openshares-lib").ChainTypes;
        ...
        switch (ops[op[0]]) { // For a list of trx types, see chain_types.coffee
            ...
            case "delegate_create":
                column = (
                    <span>
                        <TranslateWithLinks
                            string="operation.delegate_create"
                            keys={[
                                {type: "account", value: op[1].delegate_account, arg: "account"}
                            ]}
                        />
                    </span>
                );
            ...
            case "delegate_update":
                column = (
                    <span>
                        <TranslateWithLinks
                            string="operation.delegate_update"
                            keys={[
                                {type: "account", value: op[1].delegate_account, arg: "account"}
                            ]}
                        />
            ...
            case "delegate_withdraw_pay":
                console.log("delegate_withdraw_pay:", op[1].delegate_account);
                if (current === op[1].delegate_account) {
                    column = (
                        <span>
                            <Translate component="span" content="transaction.delegate_pay" />
            ...
            case "council_member_create":
                column = (
                    <span>
                        <Translate component="span" content="transaction.council_member_create" />
                        &nbsp;{this.linkToAccount(op[1].council_member_account)}
                    </span>
                );
                break;
            ...
            case "council_member_update_global_parameters":
                console.log("council_member_update_global_parameters op:", op);
                column = (
                    <span>
                        <TranslateWithLinks
                            string="operation.council_member_update_global_parameters"
                            keys={[
