...
const CORE_ASSET = "OPS"; // Setting this to OPS to prevent loading issues when used with OPS chain which is the most usual case currently

const STORAGE_KEY = "__capricorn__";
...
class SettingsStore {
    constructor() {
        ...
        this.defaultSettings = Immutable.Map({
            locale: "en",
            apiServer: "ws://seed1.openshares.net:26000",
            faucet_address: "http://seed4.openshares.net:3000",
            unit: CORE_ASSET,
            showSettles: false,
        ...
        this.preferredBases = Immutable.List([CORE_ASSET, "BTC", "PHP"]);
        ...
        let apiServer = [
            {url: "ws://seed1.openshares.net:26000", location: "Seed 1"},
            {url: "ws://seed2.openshares.net:26000", location: "Seed 2"},
            {url: "ws://seed3.openshares.net:26000", location: "Seed 3"},
            {url: "ws://seed4.openshares.net:26000", location: "Seed 4"}
        ];
