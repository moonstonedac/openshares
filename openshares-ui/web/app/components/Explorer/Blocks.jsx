...
import LinkToDelegateById from "../Blockchain/LinkToDelegateById";
                ...
                return (
                        <tr key={block.id}>
                            ...
                            <td><FormattedDate
                                ...
                                format="time"
                            /></td>
                            <td><LinkToDelegateById delegate={block.delegate} /></td>
                ...
                <div  className="align-center grid-block shrink small-horizontal  blocks-row">
                    <div className="grid-block text-center small-6 medium-3">
                        <div className="grid-content no-overflow clear-fix">
                            <span className="txtlabel subheader"><Translate component="span" content="explorer.blocks.active_delegates" /></span>
                            <h2 className="txtlabel success">
                                {globalObject.get("active_delegates").size}
                            </h2>
                        </div>
                    </div>
                    ...
                    <div className="grid-block text-center small-6 medium-3">
                        <div className="grid-content no-overflow clear-fix">
                            <span className="txtlabel subheader"><Translate component="span" content="explorer.blocks.active_council_members" /></span>
                            <h2 className="txtlabel success">
                                {globalObject.get("active_council_members").size}
                            </h2>
                        </div>
                    </div>
                                ...
                                <table className="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><Translate component="span" content="explorer.block.delegate" /></th>
