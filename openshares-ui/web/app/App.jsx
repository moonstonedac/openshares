...
import CouncilMembers from "./components/Explorer/CouncilMembers";
...
let routes = (
    <Route path="/" component={RootIntl} onEnter={willTransitionTo}>
        ...
        <Route path="/explorer/delegates" component={Delegates}>
            <IndexRoute component={Delegates}/>
        </Route>
        <Route path="/explorer/council-members" component={CouncilMembers}>
            <IndexRoute component={CouncilMembers}/>
        </Route>
