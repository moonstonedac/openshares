        ...
        trx.operations.forEach((op, opIndex) => {
            ...
            switch (ops[op[0]]) { // For a list of trx types, see chain_types.coffee
                ...
                case "account_update":
                    ...
                    {
                       console.log( "num delegates: ", op[1].new_options.num_delegate )
                       ...
                       rows.push(
                                   <tr key={key++}>
                                       <td><Translate component="span" content="account.options.num_council" /></td>
                                       <td>{op[1].new_options.num_council}</td>
                                   </tr>
                       );
                       rows.push(
                                   <tr key={key++}>
                                       <td><Translate component="span" content="account.options.num_delegates" /></td>
                                       <td>{op[1].new_options.num_delegate}</td>
                                   </tr>
                       );
                       rows.push(
                                   <tr key={key++}>
                ...
                case "council_member_create":
                    ...
                    rows.push(
                        <tr key={key++}>
                            <td><Translate component="span" content="explorer.council_member.title" /></td>
                            <td>{this.linkToAccount(op[1].council_member_account)}</td>
                        </tr>
                    );
                ...
                case "delegate_create":
                    ...
                    rows.push(
                        <tr key={key++}>
                            <td><Translate component="span" content="explorer.block.delegate" /></td>
