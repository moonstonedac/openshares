        ...
        return (
            <div className="grid-block page-layout flex-start">
                <div className="grid-block regular-padding small-up-1 medium-up-2 large-up-3">
                        ...
                        <ExplorerCard>
                            <Link to="explorer/council-members">
                                <div>
                                    <Icon name="council_members" size="5x" fillClass="fill-black"/>
                                </div>
                                <div className="card-divider text-center">
                                    <Translate component="span" content="explorer.council_members.title" />
                                </div>
                            </Link>
                        </ExplorerCard>
                        <ExplorerCard>
