...
import {PrivateKey, Address, Aes, PublicKey, hash} from "openshares-lib";
import {Apis, ChainConfig} from "openshares-ws";
...
export default class ImportKeys extends Component {
    ...
    /** OPS 1.0 client wallet_export_keys format. */
    _parseImportKeyUpload(json_contents, file_name, update_state) {
        ...
        // OPS 1.0 wallets may have a lot of generated but unused keys or spent TITAN addresses making
    ...
    /**
    OPS 1.0 hosted wallet backup (wallet.openshares.org) is supported.

    OPS 1.0 native wallets should use wallet_export_keys instead of a wallet backup.
    ...
    */
    _parseWalletJson(json_contents) {
        ...
        let savePubkeyAccount = function (pubkey, account_name) {
            ...
            address = "OPS" + address.substring(3);
        ...
        try {
            ...
            if( ! encrypted_brainkey)
                throw "Please use a OPS 1.0 wallet_export_keys file instead";
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <form onSubmit={this._passwordCheck.bind(this)}>
                                <label><Translate content="wallet.ops_09_export" />
