...
var asset_update_openasset_operation_fee_parameters = new Serializer( 
    "asset_update_openasset_operation_fee_parameters",
    {fee: uint64}
);
...
var delegate_create_operation_fee_parameters = new Serializer( 
    "delegate_create_operation_fee_parameters",
    {fee: uint64}
);

var delegate_update_operation_fee_parameters = new Serializer( 
    "delegate_update_operation_fee_parameters",
    {fee: int64}
);
...
var council_member_create_operation_fee_parameters = new Serializer( 
    "council_member_create_operation_fee_parameters",
    {fee: uint64}
);

var council_member_update_operation_fee_parameters = new Serializer( 
    "council_member_update_operation_fee_parameters",
    {fee: uint64}
);

var council_member_update_global_parameters_operation_fee_parameters = new Serializer( 
    "council_member_update_global_parameters_operation_fee_parameters",
    {fee: uint64}
);
...
var signed_block = new Serializer( 
    ...
    delegate: protocol_id_type("delegate"),
...
var openasset_options = new Serializer( 
    "openasset_options",
...
var asset_create = new Serializer( 
    ...
    openasset_opts: optional(openasset_options),
...
var asset_update_openasset = new Serializer( 
    "asset_update_openasset",
    {fee: asset,
    issuer: protocol_id_type("account"),
    asset_to_update: protocol_id_type("asset"),
    new_options: openasset_options,
    extensions: set(future_extensions)}
);
...
var delegate_create = new Serializer( 
    "delegate_create",
    {fee: asset,
...
var delegate_update = new Serializer( 
    "delegate_update",
    {fee: asset,
    delegate: protocol_id_type("delegate"),
    delegate_account: protocol_id_type("account"),
...
var council_member_create = new Serializer( 
    "council_member_create",
    {fee: asset,
    council_member_account: protocol_id_type("account"),
    url: string}
);

var council_member_update = new Serializer( 
    "council_member_update",
    {fee: asset,
    council_member: protocol_id_type("council_member"),
    council_member_account: protocol_id_type("account"),
    new_url: optional(string)}
);
...
var chain_parameters = new Serializer( 
    ...
    council_proposal_review_period: uint32,
    ...
    maximum_delegate_count: uint16,
    maximum_council_count: uint16,
...
var council_member_update_global_parameters = new Serializer( 
    "council_member_update_global_parameters",
    {fee: asset,
