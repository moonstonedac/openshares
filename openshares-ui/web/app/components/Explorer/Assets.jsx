...
class Assets extends React.Component {
    ...
    render() {
        ...
        let uia = assets.filter(a => {
            ...
            let marketID = asset.symbol + "_" + (description.market ? description.market : coreAsset ? coreAsset.get("symbol") : "OPS");
        ...
        let mia = assets.filter(a => {
            return a.openasset_data && !a.openasset_data.is_prediction_market && a.symbol.indexOf(this.state.filterMPA) !== -1;
        }).map((asset) => {
            let description = assetUtils.parseDescription(asset.options.description);
        ...
        let pm = assets.filter(a => {
            ...
            return (
                a.openasset_data &&
                a.openasset_data.is_prediction_market &&
