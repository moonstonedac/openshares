...
import LinkToDelegateById from "./LinkToDelegateById";
                ...
                <div className="grid-content">
                        ...
                        <ul>
                           <li><Translate component="span" content="explorer.block.date" />:  {block ? <FormattedDate
                            ...
                            <li><Translate component="span" content="explorer.block.delegate" />:  {block ? <LinkToDelegateById delegate={block.delegate} /> : null}</li>
