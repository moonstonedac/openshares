    ...
    var config = {
        ...
        module: {
            loaders: [
                {
                    test: /\.jsx$/,
                    include: [path.join(root_dir, "app"), path.join(root_dir, "node_modules/react-foundation-apps"), "/home/sigve/Dev/capricorn/react-foundation-apps"],
