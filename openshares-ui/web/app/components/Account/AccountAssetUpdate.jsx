...
import {OpenAssetOptions} from "./AccountAssetCreate";
...
class AccountAssetUpdate extends React.Component {
    ...
    resetState(props) {
        ...
        let isOpenAsset = asset.openasset_data_id !== undefined;
        ...
        console.log("isOpenAsset:", isOpenAsset);

        let flagBooleans = assetUtils.getFlagBooleans(asset.options.flags, isOpenAsset);
        let permissionBooleans = assetUtils.getFlagBooleans(asset.options.issuer_permissions, isOpenAsset);
        ...
        return {
            ...
            fundPoolAmount: 0,
            claimFeesAmount: 0,
            openasset_opts: isOpenAsset ? asset.openasset.options : null,
            original_openasset_opts: isOpenAsset ? props.asset.getIn(["openasset", "options"]).toJS() : null,
            marketInput: ""
        };
    }
    ...
    _updateAsset(e) {
        ...
        let {update, issuer, new_issuer_account, core_exchange_rate, flagBooleans,
            permissionBooleans, isOpenAsset, openasset_opts, original_openasset_opts} = this.state;
        ...
        AssetActions.updateAsset(issuer, new_issuer_account, update, core_exchange_rate, this.props.asset,
            flags, permissions, isOpenAsset, openasset_opts, original_openasset_opts, description).then(result => {
    ...
    onChangeOpenAssetOpts(value, e) {
        ...
        switch (value) {
            ...
            default:
                openasset_opts[value] = parseInt(e.target.value, 10);
                break;
        }
    ...
    render() {
        ...
        let {errors, isValid, update, assets, core_exchange_rate, flagBooleans,
            permissionBooleans, fundPoolAmount, claimFeesAmount, isOpenAsset, openasset_opts} = this.state;
        ...
        let originalPermissions = assetUtils.getFlagBooleans(asset.getIn(["options", "issuer_permissions"]), asset.get("openasset") !== undefined);
        ...
        let isPredictionMarketAsset = asset.getIn(["openasset", "is_prediction_market"]);
                        ...
                        <Tabs setting="updateAssetTab" style={{maxWidth: "800px"}} contentClass="grid-block shrink small-vertical medium-horizontal">
                            ...
                            <Tab title="explorer.asset.fee_pool.title">
                                <div className="small-12 large-8 grid-content">
                                    ...
                                    {/* Claim fees, disabled until delegate node update gets pushed to openledger*/}
