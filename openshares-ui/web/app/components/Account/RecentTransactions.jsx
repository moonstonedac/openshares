...
class RecentTransactions extends React.Component {
    ...
    componentDidUpdate() {
        if (this.state.csvExport) {
            ...
            var today = new Date();
            saveAs(blob, "opshist-" + today.getFullYear() + "-" + today.getMonth() + "-" + today.getDate() + ".csv");
        }
    ...
    render() {
        ...
        if (true || this.props.showFilters) {
            ...
            "delegate_withdraw_pay", "vesting_balance_withdraw"]
            .map(type => {
                    ...
                    <div ref="header">
                        ...
                        <div className="block-content-header">
                            ...
                            <div className="float-right">
                                <select className="ops-select" value={this.state.filter} onChange={this._onChangeFilter.bind(this)}>{options}</select>
                            </div>) : null}
                        </div>
