...
class VoteStore extends BaseStore {
    ...
    constructor() {
        super();
        this.i_proxies = {};
        this.i_council_member = {};
        this.i_delegates = {};
        this.i_budget_items = {};
        this.c_proxies = {};
        this.c_council_members = {};
        this.c_delegates = {};
        this.c_budget_items = {};
    ...
    hasChanges(account_name) {
        return this.i_council_member[account_name] !== this.c_council_members[account_name] ||
    ...
    getAccountJsonWithChanges(account_name) {
        ...
        let votes = []
            .concat(this.listToVoteOptions(COUNCIL_MEMBER, this.c_council_members[account_name], account_name_to_id))
    ...
    onCancelChanges(account_name) {
        ...
        this.c_council_members[account_name] = this.i_council_member[account_name];
    ...
    onGetAccount(result) {
        ...
        this.initContainer(this.i_council_member, this.c_council_members, account.name);
        ...
        for (let v of account.options.votes) {
            ...
            if (vt == COUNCIL_MEMBER) this.storeItem(this.i_council_member, this.c_council_members, account.name, account_obj);
    ...
    onPublishChanges(account_name) {
        ...
        this.i_council_member[account_name] = this.c_council_members[account_name];
        this.i_delegates[account_name] = this.c_delegates[account_name];
        this.i_budget_items[account_name] = this.c_budget_items[account_name];
        this.i_proxies[account_name] = this.c_proxies[account_name];
    }
