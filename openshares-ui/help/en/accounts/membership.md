...
Accounts in OpenShares are separated into three groups. We decided to give users
...
that is defined by the council.
...
name) must vest for some days as defined by the council.
