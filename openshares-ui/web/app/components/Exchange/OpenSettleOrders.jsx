    ...
    render() {
        ...
        if(orders.size > 0 && base && quote) {
            ...
            if (orders.first().balance.asset_id === quote.get("id")) {
                offset_percent -= quote.getIn(["openasset", "options", "force_settlement_offset_percent"]) / 100;
            } else {
                offset_percent -= base.getIn(["openasset", "options", "force_settlement_offset_percent"]) / 100;
            }
