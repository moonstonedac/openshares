...
class CollateralPosition extends React.Component {
    ...
    _getFeedPrice() {
        ...
        return 1 / utils.get_asset_price(
            this.props.debtAsset.getIn(["openasset", "current_feed", "settlement_price", "quote", "amount"]),
            this.props.collateralAsset,
            this.props.debtAsset.getIn(["openasset", "current_feed", "settlement_price", "base", "amount"]),
