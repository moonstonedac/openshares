...
var {ChainConfig} = require('openshares-ws');
...
class PublicKey {
    ...
    /** ops::blockchain::address (unique but not a full public key) */
    toBlockchainAddress() {
    ...
    */
    ...
    /**
        @arg {string} public_key - like CAPXyz...
        @arg {string} address_prefix - like CAP
