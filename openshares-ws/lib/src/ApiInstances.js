...
var CapricornApi = require("./CapricornApi");
...
/**
    ...
    Import: import { Apis } from "@capricorn/chain"
...
class ApisInstance {
    ...
    connect( cs ) {
        ...
        this.init_promise = this.ws_rpc.login(rpc_user, rpc_password).then(() => {
            ...
            this._db = new CapricornApi(this.ws_rpc, "database");
            this._net = new CapricornApi(this.ws_rpc, "network_broadcast");
            this._hist = new CapricornApi(this.ws_rpc, "history");
            this._crypt = new CapricornApi(this.ws_rpc, "crypto");
            var db_promise = this._db.init().then( ()=> {
                //https://github.com/cryptonomex/capricorn/wiki/chain-locked-tx
